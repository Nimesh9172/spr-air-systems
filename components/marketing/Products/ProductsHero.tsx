...
/**
 * Products page header — catalog intro and quote action.
 */
        ...
        >
          <div className="max-w-2xl">
            ...
            <motion.p
              ...
              variants={item}
            >
              Reciprocating and screw compressors, refrigerated and desiccant
              dryers, four-grade filters, PPR piping, and genuine compressor
              and dryer spares.
            </motion.p>
          </div>
